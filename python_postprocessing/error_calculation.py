...
axs[0].set_ylabel('Error in X (-e = s*-s) (m)')
...
axs[1].set_ylabel('Error in Y (-e = s*-s) (m)')
...
axs[2].set_ylabel('Error in Z (-e = s*-s) (m)')
...
axs[0].set_xlabel('Time')
axs[0].set_ylabel('Error in Roll (-e = s*-s) (deg)')
...
axs[1].set_xlabel('Time')
axs[1].set_ylabel('Error in Pitch (-e = s*-s) (deg)')
...
axs[2].set_xlabel('Time')
axs[2].set_ylabel('Error in Yaw (-e = s*-s) (deg)')
